                            ...
                            <div className="details"> 
                                ...
                                <div className="col-md-9">
                                    <div className="user-details">
                                        <span className="user-name"> Michael Yi</span>
                                        <span className="post-date">09/09/18</span>
                                    </div>
                                    <div className="listing-details">
                                        <div className="floor-space">
                                            <i className="far fa-square" /><span>{listing.floorSpace}ft&sup2;</span>
                                        </div>
                                        <div className="bedrooms">
                                            <i className="fas fa-bed" /><span>{listing.rooms} Bedroms</span>
                                        </div>
                                    </div>
            ...
            <section id="listings">
                ...
                <section className="sortby-area">
                    ...
                    <div className="sort-options"> 
                        <select className="sortby" name="sortby" onChange={this.props.change}>
